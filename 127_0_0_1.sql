...
-- Database: `formm`
--
CREATE DATABASE IF NOT EXISTS `formm` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `formm`;
...
--
-- Database: `login_create_no_data`
--
CREATE DATABASE IF NOT EXISTS `login_create_no_data` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `login_create_no_data`;
--
-- Database: `login_db`
--
...
ALTER TABLE `users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- Database: `login_with_data`
--
CREATE DATABASE IF NOT EXISTS `login_with_data` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `login_with_data`;
...
(1, 'John', 'Doe', 'asdf@asdf.com', 'password', '2015-10-12 10:12:47', '2015-10-12 10:12:47'),
(2, 'asdf', 'asdf', 'asdf@asdf.com', 'asdf1234', '2015-10-12 12:00:59', '2015-10-12 12:00:59'),
(3, 'asdff', 'asdff', 'asdf1@asdf.com', 'asdf1234', '2015-10-12 12:05:14', '2015-10-12 12:05:14'),
(4, 'Ray', 'Luu', 'email@google.com', 'password', '2015-10-12 12:24:46', '2015-10-12 12:24:46');
...
('root', '[{\"db\":\"registrationdb\",\"table\":\"bookings\"},{\"db\":\"registrationdb\",\"table\":\"events\"},{\"db\":\"registrationdb\",\"table\":\"tbluser\"},{\"db\":\"formm\",\"table\":\"register\"}]');
...
('root', '2020-06-14 14:26:44', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `tbluser`
--
CREATE DATABASE IF NOT EXISTS `tbluser` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tbluser`;
--
-- Database: `test`
--
